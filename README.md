...
| **FastSCODE** | Accelerated SCODE Implementation - A batch computing version of SCODE optimized for manycore processors such as GPUs, enabling efficient parameter optimization of linear ODE models for large-scale scRNA-seq datasets | [Sung et al., Bioinformatics 2025](https://doi.org/10.1093/bioinformatics/btaf624) | [cxinsys/fastscode](https://github.com/cxinsys/fastscode) |
