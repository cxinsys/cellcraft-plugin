...
def leap_input_make(adata, path_exp, path_pseudo, path_cell_select, pseudotime_column = 'dpt_pseudotime', gene_list = []):
    try:
...
# leap inputfile 생성
leap_input_make(adata, expMatrix, pseudotime, cellSelect, pseudotime_column = pseudo_of_interest, gene_list = gene_list)